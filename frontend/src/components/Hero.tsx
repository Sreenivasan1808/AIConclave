...
const Hero = () => {
  return (
    <div className="min-h-[60vh] w-full bg-[url('/src/assets/AIConclave.png')] flex flex-col justify-center items-center gap-3">
        ...
        <h6 className='text-white text-xl m-0 p-0'>District Administration, Virudhunagar</h6>
        <h6 className='text-white text-xl m-0 p-0'>and</h6>
        <h6 className='text-white text-xl'>Mepco Schlenk Engineering College</h6>
        <h6 className='text-white text-xl'>proudly presents</h6>
        </div>
